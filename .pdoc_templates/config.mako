<%!
    ...
    git_link_template = 'https://github.com/mfesiem/msiempy/blob/{commit}/{path}#L{start_line}-L{end_line}'
    ...
    #google_search_query = 'inurl:mfesiem.github.io/docs/msiempy inurl:github.com/mfesiem/msiempy'
