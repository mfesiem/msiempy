...
tag="$(git describe --exact-match --tags 2>&1 || echo 'Not a tagged version')"
...
*This is an autogenerated index for msiempy version ${project_version}@[${git_sha}](https://github.com/mfesiem/msiempy/tree/${git_sha})*.  
*${tag}* 
