...
<!-- This file should not be directly edited, edit the script build_docs.sh instead -->
...
**[View the Python API Reference](msiempy.html)** 
...
For more exemples, see the [samples folder](https://github.com/mfesiem/msiempy/tree/master/samples) or
the [tests](https://github.com/mfesiem/msiempy/tree/master/tests) for other scripts. 
