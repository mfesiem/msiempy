...
class T(unittest.TestCase):
    ...
    def test_add_remove_value(self):
        ...
        if len(watchlist_manager.search('TEST-msiempy'))>0:
            ...
            print(watchlist_manager)
            ip = "{}.{}.{}.{}".format(randint(1,253),randint(1,253),randint(1,253),randint(1,253))
            ...
            self.assertIn(ip, test_wl['values'], "The test ip does not seem to have been added to wl")
            ...
            self.assertNotIn(ip, test_wl['values'], "The test ip does not seem to have been removed from wl")
